...
- Who currently fills each of the twenty seats (PA, CMO, Head of Content, CSO, CFO, Controller, Bookkeeper, CTO, Head of Engineering, Developer, CCO, Head of Author Success, Client Success, CHRO, People Ops, VP Campaigns, Campaign Coordinator, VP Retreats, Retreat Producer) — none is recorded except COO (Anthony C. Garcia, public title). Do not assign Jhana or Bob to any of them; their Role isn't recorded either (see [handbook/people.md](handbook/people.md)).
- The production stack (Head of Engineering, Developer) — not written down in this repo, same gap already carried by CTO.
- Head of Demand, Head of Sales, and SDR — all unassigned (Head of Sales and SDR report into CSO; Head of Demand surfaces at the Attract/Place jobs in [handbook/how-money-moves.md](handbook/how-money-moves.md)). These are the only unassigned-role names sourced — no Demand, Sales, or SDR job was invented beyond them.
