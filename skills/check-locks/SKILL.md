...
- **Never treat the M5 as the company desk** — the M1 is the office, the M5 is the shop only, and it stays parked until Michael says go. Never move the office or Grok Bot onto the M5, and never plan work that assumes a VM, a GKE cluster, or a local LLM exists. See [handbook/locks.md](../../handbook/locks.md).
