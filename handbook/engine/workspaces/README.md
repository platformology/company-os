# handbook/engine/workspaces/ — one folder per seat
...
| Seat | Folder | Status | Who fills it |
|---|---|---|---|
| PA | [pa/](pa/) | Assigned | Not recorded |
...
| CTO | [cto/](cto/) | Assigned | Not recorded |
| Head of Engineering | [head-of-engineering/](head-of-engineering/) | **Parked** — starts nothing | Not recorded |
| Developer | [developer/](developer/) | **Parked** — starts nothing | Not recorded |
| CCO | [cco/](cco/) | Assigned | Not recorded |
| Head of Author Success | [head-of-author-success/](head-of-author-success/) | Assigned | Not recorded |
| Client Success | [client-success/](client-success/) | Assigned | Not recorded |
| CHRO | [chro/](chro/) | Assigned | Not recorded |
| People Ops | [people-ops/](people-ops/) | Assigned | Not recorded |
| VP Campaigns | [vp-campaigns/](vp-campaigns/) | Assigned | Not recorded |
| Campaign Coordinator | [campaign-coordinator/](campaign-coordinator/) | Assigned | Not recorded |
...
- **`SOUL.md`** — who the seat is, what it owns, what is not its seat, and the boundaries. Cut from [bodies/](../../bodies/README.md).
- **`AGENTS.md`** — the pass in order, the only hands it has, what done looks like, who it hands to, what it must never do. Cut from [desks/](../../desks/README.md) and the seat's row on [seat-job-map.md](../../seat-job-map.md).
- **`IDENTITY.md`** — the seat's name, slug, status, and holder. Name only: no vibe, no emoji, no invented personality.
...
1. **The seat page wins.** If a file in here and `handbook/seats/<slug>.md` disagree, the seat page is right and the file is wrong. Name the disagreement; do not edit the seat page to match.
2. **No send without Michael.** Every `SOUL.md` and every `AGENTS.md` says it. See [locks.md](../../locks.md), which is the list itself and is not restated here.
