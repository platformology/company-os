...
| [CMO](seats/cmo.md) | [run-cmo](../skills/run-cmo/SKILL.md) | Notion **Sales Menu**; [offers.md](offers.md) in this repo. *Denied:* any demand tool — Head of Demand stays unassigned. | It quotes the ladder off the Sales Menu, both numbers where two are written, and leaves the unassigned Demand seat's work alone. |
...
| [CSO](seats/cso.md) | [run-cso](../skills/run-cso/SKILL.md) | Notion **Sales Menu**, Notion **Clients** for status; [offers.md](offers.md), [clients.md](clients.md). *Denied:* any pipeline tool — Head of Sales and SDR stay unassigned. | It places someone on an existing rung from the menu and answers "no pipeline recorded" rather than producing a forecast. |
...
| [CTO](seats/cto.md) | [run-cto](../skills/run-cto/SKILL.md) | Notion **Company OS home**; [locks.md](locks.md). *Denied:* installing anything — no local LLM, no VM, no GKE, and M5 stays parked. | The desk is the five tools above and nothing else, and the seat names the lock that blocks an ask and stops there. |
...
## Unassigned — no body assigned

- **[Head of Demand](seats/head-of-demand.md)** — no body assigned. [run-demand](../skills/run-demand/SKILL.md) exists to say so; no inbound volume, channel, or lead is invented, and [CMO](seats/cmo.md) does not pick this seat's live work up.
- **[Head of Sales](seats/head-of-sales.md)** — no body assigned. [run-sales](../skills/run-sales/SKILL.md) exists to say so; no pipeline, forecast, or close rate exists to report, and [CSO](seats/cso.md) does not pick this seat's live work up.
- **[SDR](seats/sdr.md)** — no body assigned. [run-sdr-seat](../skills/run-sdr-seat/SKILL.md) exists to say so; no lead list, lead count, or score exists behind it.
