...
| [engine.md](engine.md) | The engine — the same twenty-three seats written the way OpenClaw expects them, one workspace folder each, plus what a new hire does on the M1 after Qwen assembles. Draft, not merged, and it installs nothing | Handing the seats to somebody who has to stand them up, rather than read about them |
