...
Run this file three ways: paste it into Claude, read it here on this Mac, or make it the SYSTEM of an `sdr` model built on the shared office hand. How: [bodies README](README.md). Seat page: [seats/sdr.md](../seats/sdr.md) — if the two ever disagree, the seat page wins.
