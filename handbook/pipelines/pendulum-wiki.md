...
Those child stages are the holes the leftover page already names. Nothing gets added to that list here, and none of them gets filled in to make the seat look busy. Do not build a wiki. Do not invent that one exists, a page, or KPI Current.
...
Source: seats/pendulum-wiki.md, leftovers/pendulum-wiki.md, seats/head-of-content.md, runtime-wiring.md, company-run.md, locks.md
