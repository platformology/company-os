...
Twelve seats, only the ones asked for. A seat is a function, not a person — [JGalego/TeamAPI](https://github.com/JGalego/TeamAPI) `docs/spec/teamapi-extended-v1.md` puts it directly: "a role can be vacant... independent of whoever currently fills each seat." Each page below keeps that split, and uses the Purpose / Domains / Accountabilities shape from [holacracyone/Holacracy-Constitution](https://github.com/holacracyone/Holacracy-Constitution) `Holacracy-Constitution.md`.
