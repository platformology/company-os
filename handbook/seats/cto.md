...
**Owns:** Very little, on purpose. This is where the hardest locks land: no program GitHub, no VMs, no GKE, M5 parked until the machine is physically in hand. See [locks.md](../locks.md).
...
**Locked:** No program GitHub. No VMs. No GKE. M5 parked until the machine is in hand. No send without Michael. See [locks.md](../locks.md).
