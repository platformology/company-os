...
| | |
|---|---|
| **This pass covers** | Who owns demand on paper, what the seat page records, which stage of [how-money-moves.md](../how-money-moves.md) the seat would sit in, and what is not recorded — said as "not recorded" |
| **This pass refuses** | Any inbound volume, lead count, MQL/SQL number, conversion rate, channel mix, funnel, campaign, persona, ICP, advertising plan, PR plan, brand book, speaking calendar, or membership price. None of those is recorded, and a plan is not the place one gets invented |

## The SOP that runs it

The seat page opens one Notion page: [Sales Menu](https://app.notion.com/p/3c025e30d68b817dae2eeb55c5902ad7). Open it **to see the company, not to invent inbound off it** — that is the desk's own wording. The Sales Menu is the live ladder; a ladder is not an inbound plan.

**There is no demand or inbound SOP recorded anywhere in this repo — named missing.** Do not draft one to fill the hole, and do not borrow another company's. The nearest sourced thing to this seat's stage is the gap already named at Attract: **the lead magnet has no Offers row** ([offers.md](../offers.md)), and that is exactly the stage that would use one. It does not get a price, and it does not get a row added for it.

Prices, if one comes up on the way through, come off [offers.md](../offers.md) and nowhere else — both numbers where the ladder shows two, and **Platinum Major List has no public price.**

## The KPI this plan is pointed at

| | |
|---|---|
| **KPI** | **Cost per consult.** Named on the [KPIs](https://app.notion.com/p/b104782240524af595577abaef8dc928) database (Notion), where the Owner field reads Head of Demand. Copied here as a name, nothing more — this repo does not restate the dashboard, and this plan does not rename, drop, or measure it. |
...
7. Asked who should fill the seat? Not recorded — see [people.md](../people.md). **Jhana and Bob have no Role recorded**, and neither gets one here; assigning either is an ask-Michael-first item on [locks.md](../locks.md).
8. Say where you looked — the seat page, the desk, the router, and the Sales Menu — so the next person does not re-run the same search.
9. If anything from this seat does go out, run [reviews/last-gate-checklist.md](../../reviews/last-gate-checklist.md) first, then stop. It sits with Michael.
...
- Who fills this seat.
- Any inbound volume, lead count, conversion rate, or channel this seat would own.
- Any demand or inbound SOP of this seat's own.
- The lead magnet has no Offers row.
- The membership price.
- Jhana's Role and Bob's Role.
- No consult count and no spend figure — so nothing to divide for **Cost per consult.**

## Never

- **Never staff this seat, or write in an accountability for it.** When it is staffed, its accountabilities get written from a source.
- Never invent an inbound volume, a lead count, an MQL/SQL number, a conversion rate, a pipeline figure, or a channel.
- Never invent a funnel, a campaign, a persona, an ICP, an advertising plan, a PR plan, a brand book, or a speaking calendar to give this seat something to do.
- Never price the lead magnet, add a row to [offers.md](../offers.md), or invent the membership price.
...
- Never quietly reassign this seat's work to the CMO, Head of Content, Head of Sales, or SDR to make the org chart look busy.
...
- **Never put a figure in a KPI Current field, including a 0**, and never compute a cost per consult from anything. The 18 Aug 2026 client count in [clients.md](../clients.md) is a separate fact and travels with its date.
