...
| [SDR](seats/sdr.md) | Unassigned | [run-sdr-seat](../skills/run-sdr-seat/SKILL.md) · [run-clients](../skills/run-clients/SKILL.md) · [campaign-lead-scoring](../skills/campaign-lead-scoring/SKILL.md) | [Campaign lead scoring draft](https://app.notion.com/p/3c125e30d68b81f89125cfbbe398c770) |
...
- **Every row above has one complete plan in [plans/](plans/README.md)** — the one job that pass takes, the SOP behind it, and the KPI it is pointed at with Current empty. On an **Unassigned** or **Parked** row the plan is how to hold that state: the honest answer, the named lock, and a stop. A plan does not staff a seat or unpark one.
